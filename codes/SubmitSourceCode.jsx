...
export default class SubmitSourceCode extends React.Component {
  ...
  render() {
    let renderInputArea = 
        this.state.currentState == SubmitSourceCodeState.INITIAL;
    let renderProgressBar = 
        this.state.currentState == SubmitSourceCodeState.SUBMITTING;
    let renderStyeReport = 
        this.state.currentState == SubmitSourceCodeState.SUCCESS;
    let renderErrorMessage = 
        this.state.currentState == SubmitSourceCodeState.ERROR;
